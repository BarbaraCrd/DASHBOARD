<template>
                        ...
                        <div class="card">
                            ...
                            <div class="title"><p><input type="text" class="city" v-model="city" placeholder="city"></p><button class="btn" type="submit" @click="getMeteo(url)">CHANGE CITY </button> </div>
                            <div class="temp">{{this.meteo.temp}}<sup>&deg;c</sup></div>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="header">Wind degree</div>
                                        <div class="value">{{this.wind.deg}}°</div>
                                    </div>
                                    <div class="col-4">
                                        <div class="header">Pressure</div>
                                        <div class="value">{{this.meteo.pressure}} Pa</div>
                                    </div>      
                                    <div class="col-4">
                                        <div class="header">Feels like</div>
                                        <div class="value">{{this.meteo.feels_like}}°</div>
                                    </div>                                                                         
                                </div>
...
export default {
    ...
    if(localStorage.getItem('cityBig') == null){
        this.city = "Paris"
    }
    
    else{
        this.city = localStorage.getItem('cityBig')
    }
    ...
    methods: {
        ...
        getMeteo(url)
        {
        localStorage.setItem('cityBig', this.city)
